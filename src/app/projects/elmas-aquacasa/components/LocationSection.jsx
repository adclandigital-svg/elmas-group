...
const contentData = {
  schools: {
    ...
    items: [
      ["The School of Scholars", "0.1 km"],
      ["SKS World School", "0.3 km"],
      ["BLS World School", "0.38 km"],
      ["The Wisdom Tree School", "0.7 km"],
      ["Rama Devi International School", "1 km"],
      ["Harshdeep Public School", "1.1 km"],
      ["Golden Valley International School", "1.3 km"],
      ["Royal World International School", "1.36 km"],
    ],
  },
  hospitals: {
    ...
    items: [
      ["Kashvi Hospital", "1 km"],
      ["Kaith Hospital", "1.6 km"],
      ["Yatharth Hospital", "2 km"],
      ["NUmed Hospital", "3 km"],
  ...
  shopping: {
    ...
    items: [
      ["PKS Town Central Mall", "5 minutes"],
      ["Artha Mart", "5 minutes"],
      ["Gaur City Mall", "10 minutes"],
      ["Bhutani 32 City Centre Mall", "15 minutes"],
    ],
  },
  connectivity: {
    ...
    title: "Connectivity",
    items: [
      ["NH-24 Expressway", "6 km"],
      ["FNG Expressway", "4 km"],
      ["Noida–Greater Noida Expressway", "10 km"],
      ["Jewar Airport (Upcoming)", "35 km"],
      ["Sector-52 Metro Station", "8 km"],
      ["Gaur City Chowk / Bus Stop", "2 km"],
    ],
  },
};
      ...
      <div className="luxury-wrap">
        ...
        <div className="luxury-head">
          <div className="luxury-head-left">
            <div className="luxury-eyebrow">Elmas Aqua Casa</div>
            <h2>
              Luxury That Begins With <span>Location</span>
            </h2>
            <p>
